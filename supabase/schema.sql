...
create table public.fba_replenishment_request_items (
  id uuid primary key default gen_random_uuid(),
...
create index idx_fba_request_items_request_id on public.fba_replenishment_request_items(request_id);
create index idx_fba_request_items_product_id on public.fba_replenishment_request_items(product_id);
create index idx_fba_request_items_sku_id on public.fba_replenishment_request_items(sku_id);
...
create index idx_production_order_items_order_id on public.production_order_items(production_order_id);
...
create index idx_inventory_items_product_sku_id on public.inventory_items(product_sku_id);
create index idx_inventory_items_material_id on public.inventory_items(material_id);
create index idx_inventory_items_warehouse_material on public.inventory_items(warehouse_id, material_id);
create index idx_inventory_items_warehouse_product_sku on public.inventory_items(warehouse_id, product_sku_id);
...
create index idx_inventory_transactions_product_sku_id on public.inventory_transactions(product_sku_id);
